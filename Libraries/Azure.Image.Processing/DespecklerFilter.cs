...
namespace Azure.Image.Processing
{
    ...
    public class DespeckleFilter
    {
        ...
        private unsafe WriteableBitmap Process16BitChannel(WriteableBitmap srcImage)
        {
            ...
            ushort* pOrigData = (ushort*)(byte*)srcImage.BackBuffer.ToPointer();
            ushort* pCopyOfData = (ushort*)(byte*)cpyImage.BackBuffer.ToPointer();
            ushort* pCpyBorder = (ushort*)(byte*)cpyBorder.BackBuffer.ToPointer();
