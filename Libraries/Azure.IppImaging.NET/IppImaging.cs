    ...
    namespace Imaging
    {
        ...
        public static class IppImaging
        {
            ...
            public static PixelFormatType GetPixelFormatType(PixelFormat pixelFormat)
            {
                ...
                {
                    return PixelFormatType.P32f_C1;
                }
            ...
            public static unsafe IppStatus Max(byte* pSrc, int srcStep, PixelFormatType pixelFormat, Rect roiRect, ref uint maxValue)
            {
                IppStatus ippStatus = IppStatus.ippStsNoErr;
                ...
                if (_Is64bit)
                {
                    switch (pixelFormat)
                    {
                        case PixelFormatType.P8u_C1:
                            ...
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_8u_C1R(pSrcData, srcStep, roiSize, pMaxValue8);
                            maxValue = maxValue8;
                            break;
                        case PixelFormatType.P8u_C3:
                            byte[] arrMaxValue8 = new byte[3];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 3 * (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_8u_C3R(pSrcData, srcStep, roiSize, arrMaxValue8);
                            maxValue = arrMaxValue8.Max();
                            break;
                        case PixelFormatType.P8u_C4:
                            byte[] arrMaxValue8uC4 = new byte[4];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 4 * (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_8u_C4R(pSrcData, srcStep, roiSize, arrMaxValue8uC4);
                        ...
                        case PixelFormatType.P16u_C1:
                            ...
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 2 * (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_16u_C1R(pSrcData, srcStep, roiSize, pMaxValue16);
                            maxValue = maxValue16;
                            break;
                        case PixelFormatType.P16u_C3:
                            ushort[] usMaxValue = new ushort[3];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 3 * 2 * (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_16u_C3R(pSrcData, srcStep, roiSize, usMaxValue);
                            maxValue = usMaxValue.Max();
                            break;
                        case PixelFormatType.P16u_C4:
                            ushort[] usMaxValue16uC4 = new ushort[4];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 4 * 2 * (int)roiRect.X;
                            ippStatus = IppImaging64.ippiMax_16u_C4R(pSrcData, srcStep, roiSize, usMaxValue16uC4);
                ...
                else
                {
                    switch (pixelFormat)
                    {
                        case PixelFormatType.P8u_C1:
                            ...
                            byte* pMaxValue8 = &maxValue8;
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_8u_C1R(pSrcData, srcStep, roiSize, pMaxValue8);
                            maxValue = maxValue8;
                            break;
                        case PixelFormatType.P8u_C3:
                            byte[] arrMaxValue8 = new byte[3];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 3 * (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_8u_C3R(pSrcData, srcStep, roiSize, arrMaxValue8);
                            maxValue = arrMaxValue8.Max();
                            break;
                        case PixelFormatType.P8u_C4:
                            byte[] arrMaxValue8uC4 = new byte[4];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 4 * (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_8u_C4R(pSrcData, srcStep, roiSize, arrMaxValue8uC4);
                            maxValue = arrMaxValue8uC4.Max();
                            break;
                        case PixelFormatType.P16u_C1:
                            ushort maxValue16 = 0;
                            ushort* pMaxValue16 = &maxValue16;
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 2 * (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_16u_C1R(pSrcData, srcStep, roiSize, pMaxValue16);
                            maxValue = maxValue16;
                            break;
                        case PixelFormatType.P16u_C3:
                            ushort[] usMaxValue = new ushort[3];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 3 * 2 * (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_16u_C3R(pSrcData, srcStep, roiSize, usMaxValue);
                            maxValue = usMaxValue.Max();
                            break;
                        case PixelFormatType.P16u_C4:
                            ushort[] usMaxValue16uC4 = new ushort[4];
                            pSrcData = pSrc + srcStep * (int)roiRect.Y + 4 * 2 * (int)roiRect.X;
                            ippStatus = IppImaging32.ippiMax_16u_C4R(pSrcData, srcStep, roiSize, usMaxValue16uC4);
                            maxValue = usMaxValue16uC4.Max();
                            break;
                    }
                }
            ...
            public static unsafe IppStatus MinMaxMC(byte* pSrc, int srcStep, PixelFormatType pixelFormat, Rect roiRect, ref uint minValue, ref uint maxValue, ref uint[] arrMin, ref uint[] arrMax)
            {
                IppStatus ippStatus = IppStatus.ippStsNoErr;
                ...
                if (_Is64bit)
                {
                    switch (pixelFormat)
                    {
                        ...
                        case PixelFormatType.P8u_C3:
                            ...
                            minValue = arrMinValue8.Min();
                            maxValue = arrMaxValue8.Max();
                            arrMin = new uint[] { arrMinValue8[0], arrMinValue8[1], arrMinValue8[2] };
                            arrMax = new uint[] { arrMaxValue8[0], arrMaxValue8[1], arrMaxValue8[2] };
                            break;
                        case PixelFormatType.P8u_C4:
                            byte[] arrMinValue8uC4 = new byte[4];
                            byte[] arrMaxValue8uC4 = new byte[4];
                            ...
                            minValue = arrMinValue8uC4.Min();
                            maxValue = arrMaxValue8uC4.Max();
                            arrMin = new uint[] { arrMinValue8uC4[0], arrMinValue8uC4[1], arrMinValue8uC4[2], arrMinValue8uC4[3] };
                            arrMin = new uint[] { arrMaxValue8uC4[0], arrMaxValue8uC4[1], arrMaxValue8uC4[2], arrMaxValue8uC4[3] };
                            break;
                        case PixelFormatType.P16u_C1:
                            ushort minValue16 = 0;
                            ushort maxValue16 = 0;
                        ...
                        case PixelFormatType.P16u_C3:
                            ...
                            minValue = usMinValue.Min();
                            maxValue = usMaxValue.Max();
                            arrMin = new uint[] { usMinValue[0], usMinValue[1], usMinValue[2] };
                            arrMax = new uint[] { usMaxValue[0], usMaxValue[1], usMaxValue[2] };
                            break;
                        case PixelFormatType.P16u_C4:
                            ushort[] usMinValue16uC4 = new ushort[4];
                            ushort[] usMaxValue16uC4 = new ushort[4];
                            ...
                            minValue = usMinValue16uC4.Min();
                            maxValue = usMaxValue16uC4.Max();
                            arrMin = new uint[] { usMinValue16uC4[0], usMinValue16uC4[1], usMinValue16uC4[2], usMinValue16uC4[3] };
                            arrMin = new uint[] { usMaxValue16uC4[0], usMaxValue16uC4[1], usMaxValue16uC4[2], usMaxValue16uC4[3] };
                            break;
                    }
                }
                else
            ...
            public static unsafe IppStatus Rotate(byte* pSrc, Size srcSize, int srcStep, PixelFormatType pixelFormat, byte* pDst, int dstStep, Size dstSize, double angle)
            {
                IppStatus ippStatus = IppStatus.ippStsNoErr;
                ...
                ippSrcRect.x = 0;
                ippSrcRect.y = 0;
                ippSrcRect.width = srcWidth;
                ippSrcRect.height = srcHeight;
                IppiRect ippDstRect;
                ippDstRect.x = 0;
                ippDstRect.y = 0;
                ippDstRect.width = dstWidth;
                ippDstRect.height = dstHeight;
                //Rotate with the respect to the center of the image
                double xShift;
                double yShift;
                double* pxShift = &xShift;
                double* pyShift = &yShift;

                double xCenterSrc = (double)srcWidth / 2.0;
                double yCenterSrc = (double)srcHeight / 2.0;
                double xCenterDst = (double)dstWidth / 2.0;
                double yCenterDst = (double)dstHeight / 2.0;
                ...
                if (_Is64bit)
                {
                    IppImaging64.ippiGetRotateShift(xCenterSrc, yCenterSrc, angle, pxShift, pyShift);
                    IppImaging64.ippiAddRotateShift(1.0, 1.0, angle, pxShift, pyShift);
                    xShift += xCenterDst - xCenterSrc;
                    yShift += yCenterDst - yCenterSrc;
                    IppImaging64.ippiGetRotateQuad(ippSrcRect, quad, angle, xShift, yShift);
                    IppImaging64.ippiGetRotateBound(ippSrcRect, bound, angle, xShift, yShift);
                    IppImaging64.ippiSet_8u_C1R(0, pDst, 6, ippDstSize);

                    switch (pixelFormat)
                    {
                        case PixelFormatType.P8u_C1:
                            ippStatus = IppImaging64.ippiRotate_8u_C1R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P8u_C3:
                            ippStatus = IppImaging64.ippiRotate_8u_C3R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P8u_C4:
                            ippStatus = IppImaging64.ippiRotate_8u_C4R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C1:
                            ippStatus = IppImaging64.ippiRotate_16u_C1R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C3:
                            ippStatus = IppImaging64.ippiRotate_16u_C3R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C4:
                            ippStatus = IppImaging64.ippiRotate_16u_C4R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                    }
                }
                else
                {
                    IppImaging32.ippiGetRotateShift(xCenterSrc, yCenterSrc, angle, pxShift, pyShift);
                    IppImaging32.ippiAddRotateShift(1.0, 1.0, angle, pxShift, pyShift);
                    xShift += xCenterDst - xCenterSrc;
                    yShift += yCenterDst - yCenterSrc;
                    IppImaging32.ippiGetRotateQuad(ippSrcRect, quad, angle, xShift, yShift);
                    IppImaging32.ippiGetRotateBound(ippSrcRect, bound, angle, xShift, yShift);
                    IppImaging32.ippiSet_8u_C1R(0, pDst, 6, ippDstSize);

                    switch (pixelFormat)
                    {
                        case PixelFormatType.P8u_C1:
                            ippStatus = IppImaging32.ippiRotate_8u_C1R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P8u_C3:
                            ippStatus = IppImaging32.ippiRotate_8u_C3R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P8u_C4:
                            ippStatus = IppImaging32.ippiRotate_8u_C4R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C1:
                            ippStatus = IppImaging32.ippiRotate_16u_C1R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C3:
                            ippStatus = IppImaging32.ippiRotate_16u_C3R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                        case PixelFormatType.P16u_C4:
                            ippStatus = IppImaging32.ippiRotate_16u_C4R(pSrc, ippSrcSize, srcStep, ippSrcRect, pDst, dstStep, ippDstRect, angle, xShift, yShift, (int)IppInter.IPPI_INTER_CUBIC);
                            break;
                    }
                }
