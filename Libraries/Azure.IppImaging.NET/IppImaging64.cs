...
namespace Azure.Ipp
{
    namespace Imaging
    {
        internal static class IppImaging64
        {
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            ...
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiRotate_8u_C4R(byte* pSrc, IppiSize srcSize, int srcStep, IppiRect srcRoi, byte* pDst, int dstStep, IppiRect dstRoi, double angle, double xShift, double yShift, int interpolation);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            ...
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiRotate_16u_C4R(byte* pSrc, IppiSize srcSize, int srcStep, IppiRect srcRoi, byte* pDst, int dstStep, IppiRect dstRoi, double angle, double xShift, double yShift, int interpolation);

            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiGetRotateShift(double xCenter, double yCenter, double angle, double* xShift, double* yShift);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAddRotateShift(double xCenter, double yCenter, double angle, double* xShift, double* yShift);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiGetRotateQuad(IppiRect srcRoi, double[,] quad, double angle, double xShift, double yShift);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiGetRotateBound(IppiRect srcRoi, double[,] bound, double angle, double xShift, double yShift);
            ...
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_8u_C1RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_8u_C3RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_8u_C4RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_16u_C1RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_16u_C3RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiAdd_16u_C4RSfs(byte* pSrc1, int src1Step, byte* pSrc2, int src2Step, byte* pDst, int dstStep, IppiSize roiSize, int scaleFactor);
            ...
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            public static unsafe extern IppStatus ippiDivC_32f_C1R(float* pSrc1, int src1Step, float value, float* pDst, int dstStep, IppiSize roiSize);
            [DllImport(@"Ipp\em64t\ippimx-6.0.dll")]
            ...
            [DllImport(@"Ipp\em64t\ippcvmx-6.0.dll")]
