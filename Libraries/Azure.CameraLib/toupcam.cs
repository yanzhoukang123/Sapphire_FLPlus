...
public class Toupcam : IDisposable
{
    ...
    /* get the version of this dll/so, which is: 55.25345.20240421 */
    ...
    * iValue: output, TOUPCAM_PIXELFORMAT_xxxx
    */
    public bool get_PixelFormatSupport(sbyte cmd, out int iValue)
    {
        ...
        return CheckHResult(Toupcam_get_PixelFormatSupport(handle_, cmd, out iValue));
    }
    ...
    */
    ...
    {
        IntPtr ptr = Toupcam_get_PixelFormatName(val);
        if (IntPtr.Zero == ptr)
            return null;
