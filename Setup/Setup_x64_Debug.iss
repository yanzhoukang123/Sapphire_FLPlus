...
[Files]
; Intel IPP
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\*; DestDir: {app}\Ipp; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\em64t\ippcoreem64t-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\em64t\ippcvmx-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\em64t\ippimx-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\em64t\libiomp5md.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\ia32\ippcore-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\ia32\ippcvpx-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\ia32\ippipx-6.0.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Ipp\ia32\libiomp5md.dll; DestDir: {app}; Flags: ignoreversion
; AForge.NET Framework
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AForge.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AForge.Imaging.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AForge.Math.dll; DestDir: {app}; Flags: ignoreversion
; AvalonDock
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AvalonDock.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AvalonDock.Themes.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AvalonDock.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\AvalonDockMVVM.dll; DestDir: {app}; Flags: ignoreversion
; Azure sapphire capture application
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.Adorners.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.CameraLib.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.CommandLib.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.GalilMotor.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.Image.Processing.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.ImagingSystem.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.Interfaces.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.IppImaging.NET.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.LaserScanner.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.LaserScanner.exe.config; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.Resources.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.SettingsManager.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.UpdateConfig.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Azure.WPF.Framework.dll; DestDir: {app}; Flags: ignoreversion
; Copy config.xml to dest app folder and temp folder (to be edit base on installation options selected).
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\config.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\config.xml; DestDir: {tmp}; Flags: dontcopy
...
; Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\config.xml; DestDir: "{commonappdata}\Azure Biosystems\Sapphire"; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\CyUSB.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\DynamicDataDisplay.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\DynamicDataDisplay.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Hats.APDCom.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Method.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\PVCam.NET.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Sapphire User Manual.pdf; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Secure.xml; DestDir: {app}; Flags: ignoreversion
; Copy SysSettings.xml to dest app folder and temp folder (to be edit base on installation options selected).
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\SysSettings.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\SysSettings.xml; DestDir: {tmp}; Flags: dontcopy
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\System.Windows.Interactivity.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\TaskDialog.dll; DestDir: {app}; Flags: ignoreversion
;Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\TaskDialog.xml; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\ToggleSwitch.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Utilities.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\WPFFolderBrowser.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\Projects\Azure.LaserScanner\Build\x64\Debug\Xceed.Wpf.Toolkit.dll; DestDir: {app}; Flags: ignoreversion
...
; Engineering GUI
Source: ..\Projects\Azure.ScannerEUI\Build\x64\Debug\Azure.ScannerEUI.exe; DestDir: {app}; Flags: ignoreversion
