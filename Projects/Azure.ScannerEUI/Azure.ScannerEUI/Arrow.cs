...
namespace Azure.ScannerEUI
{
    public sealed class Arrow : Shape
    {
        ...
        //public static readonly DependencyProperty LowWidthProperty = DependencyProperty.Register("HeadWidth", typeof(double), typeof(Arrow), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
        //public static readonly DependencyProperty LowHeightProperty = DependencyProperty.Register("HeadHeight", typeof(double), typeof(Arrow), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
        #endregion
        ...
        //[TypeConverter(typeof(LengthConverter))]
        //public double LowWidth
        //{
        //    get { return (double)base.GetValue(LowWidthProperty); }
        //    set { base.SetValue(LowWidthProperty, value); }
        //}

        //[TypeConverter(typeof(LengthConverter))]
        //public double LowHeight
        //{
        //    get { return (double)base.GetValue(LowHeightProperty); }
        //    set { base.SetValue(LowHeightProperty, value); }
        //}
